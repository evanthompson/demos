...
trying to download, install, and run db2. The output of the db2script.db2
file can be found in the scriptoutput.txt document.

Queries are numbered, and match up between input and output files.
